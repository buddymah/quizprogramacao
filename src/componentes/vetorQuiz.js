...
const perguntas = [
  {
    pergunta: "Qual é o tamanho máximo de um vetor declarado como char nome[50];?",
    opcoes: [
  ...
  {
    pergunta: "O que acontece se você acessar vetor[10] em um vetor declarado como int vetor[10];?",
    opcoes: [
